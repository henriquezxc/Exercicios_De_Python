# Software de lanchonete, onde o cliente escolhe seu lanche e no sim e somado e mostrado o resultado

# Usamos o metodo ( Def ) apenas para impresão do menu
def Menu_Inicial():
    ...
    print('____________________________________')
# Metodo para ao selecionar o lanche sempre mostrar ao usuário como sair e finalizar a compra.
def Mensagem_SAIR():
...
def Calculo_de_vezes():
    ...
    if nomes_lanches.count('X-Bacon R$ 2.98'):
        print('X-Bacon R$ 2.98',nomes_lanches.count('X-Bacon R$ 2.98'))
...
print('********************************************')
print('O Total do seu lanche foi de R$: ''%.2f'%soma)
print('********************************************')
